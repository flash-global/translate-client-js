...
var Gateway = function () {
    ...
    _createClass(Gateway, [{
        ...
        value: function pull(lang) {
            return fetch(this.generateUrl(lang)).then(function (result) {
                return result.json();
            });
        }
    }, {
...
var Manager = function () {
    ...
    _createClass(Manager, [{
        ...
        value: function translate(key) {
            ...
            return this.pullIfNeefed().then(function () {
                return _this.findTranslation(key);
            });
        }
    }, {
        key: 'pullIfNeefed',
        value: function pullIfNeefed() {
        ...
        value: function getLocalStorageTranslations() {
            ...
            if ((typeof jsonTranslations === 'undefined' ? 'undefined' : _typeof(jsonTranslations)) !== String) {
                return null;
            }
...
/***/ 0:
/*!********************************!*\
  !*** multi ./src/translate.js ***!
  \********************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./src/translate.js */"./src/translate.js");
